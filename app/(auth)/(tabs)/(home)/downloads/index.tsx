...
import { DownloadScrollingCollection } from "@/components/home/DownloadScrollingCollection";
      ...
      <View className="py-4">
        ...
        {movies.length > 0 && (
          <View className="mb-4">
            ...
            <DownloadScrollingCollection downloads={movies || []} />
          </View>
        )}
        ...
        <DownloadScrollingCollection downloads={downloadedFiles || []} />
